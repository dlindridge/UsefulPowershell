...
$Company = "MyCompany"
$Path = "C:\Scripts\NewUser" # Path to image files (probably the same as the script location)
$IconImage = "AOH_symbol.ico" # Filename for the application icon - blank for none ("")
$BackgroundImage = "AOH_background.jpg" # Filename for the background image - blank for none ("")
